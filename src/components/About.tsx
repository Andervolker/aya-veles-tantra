...
const timeline = [
  { year: "С 15 лет", text: "Обнаружил(а) дар исцеления через прикосновения и общение" },
            ...
            <div className="lg:pl-8 lg:-ml-16 z-20 relative pt-12 lg:pt-24">
              ...
              <FogReveal delay={0.4}>
                ...
                >
                  ...
                  <p>
                    В 15 лет обнаружил(а) в себе дар исцеления через прикосновения. В 28 — пережил(а)
                    клиническую смерть, что открыло связь с тонкими мирами и дало новое понимание
                    тела и сознания.
                  </p>
                  <p>
